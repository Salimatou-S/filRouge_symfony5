...
class Fournisseur
{
    ...
    {
        return $this->pays_fournisseur;
    }

    public function setPaysFournisseur(string $pays_fournisseur): self
    {
        $this->pays_fournisseur = $pays_fournisseur;
