...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 30 avr. 2022 à 13:54
...
--
-- Base de données : `filrougesymfony`
--
...
('DoctrineMigrations\\Version20220428095328', '2022-04-28 11:56:07', 81),
('DoctrineMigrations\\Version20220428115535', '2022-04-28 13:55:57', 272),
('DoctrineMigrations\\Version20220428121410', '2022-04-28 14:15:18', 42),
('DoctrineMigrations\\Version20220428145324', '2022-04-28 16:53:38', 147),
('DoctrineMigrations\\Version20220428150401', '2022-04-28 17:04:11', 37),
('DoctrineMigrations\\Version20220428153307', '2022-04-28 17:33:16', 81),
('DoctrineMigrations\\Version20220428155344', '2022-04-28 17:53:53', 145),
('DoctrineMigrations\\Version20220428164112', '2022-04-29 09:26:05', 169);
...
CREATE TABLE `fournisseur` (
  ...
  `pays_fournisseur` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `post` (
  ...
  `contenu` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `post`
  ...
  ADD KEY `IDX_5A8A6C8DF347EFB` (`produit_id`);
...
ALTER TABLE `post`
  ...
  ADD CONSTRAINT `FK_5A8A6C8DF347EFB` FOREIGN KEY (`produit_id`) REFERENCES `produit` (`id`);
